const News = (props) => {
  const {
    ...
    category_id,
    rating: { number: rating_number, badge: rating_badge },
    total_view,
    title,
    author: { name: author_name, published_date, img: author_img },
    thumbnail_url,
    image_url,
    details,
  } = props.data;
  return (
    <div className="flex flex-col max-w-lg p-6 space-y-6 overflow-hidden rounded-lg shadow-md dark:bg-gray-50 dark:text-gray-800 mb-10">
      ...
      <div>
        ...
        <p className="text-sm dark:text-gray-600">{details.slice(0, 200)}</p>
      </div>
